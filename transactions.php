...
<div class="content-wrapper">
    ...
    <?php
      ...
      $qry = "DELETE FROM budget_tbl WHERE invoicenumber = '$theid'";
   ...
   <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                <td><a onClick="javascript: return confirm(\'ARE YOU SURE YOU WANT TO DELETE THIS TRANSACTION\');" href="transactions.php?ID='.$b_row['invoicenumber'].'"><button type="submit" class="btn btn-danger btn-mini"><i class="fa fa-remove"></i> Delete</button></a></td></tr>';
                $count++;
                }
